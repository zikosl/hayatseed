  ...
  head: () => ({
    meta: [
      { title: "About — Hayatseed" },
      {
        name: "description",
        content:
          "An Algerian eco-tech startup transforming arid lands into green ecosystems.",
      },
    ],
  }),
  component: AboutPage,
      ...
      <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="surface-card rounded-[2rem] p-7">
          ...
          <div className="mt-5 space-y-3">
            <AboutFact
              label={t("about.coreFocus")}
              value={t("about.coreFocusValue")}
            />
            <AboutFact
              label={t("about.operatingStyle")}
              value={t("about.operatingStyleValue")}
            />
            <AboutFact
              label={t("about.platformDirection")}
              value={t("about.platformDirectionValue")}
            />
          </div>
        </div>
      </section>
